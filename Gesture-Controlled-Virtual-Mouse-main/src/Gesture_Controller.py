...
class Controller:
    ...
    def scrollUp():
        ...
        pyautogui.scroll(30)  # You can adjust the scroll amount as needed
    ...
    def changesystembrightness():
     ...
     currentBrightnessLv = max(0.0, min(1.0, currentBrightnessLv))  # Ensure brightness is between 0.0 and 1.0
    ...
    def changesystemvolume():
     ...
     currentVolumeLv = max(0.0, min(1.0, currentVolumeLv))  # Ensure volume is between 0.0 and 1.0
    ...
    def handle_controls(gesture, hand_result):  
        ...
        # Add these conditions for scroll up and down
        elif gesture == Gest.PINKY:  # Customize the condition based on your specific gesture
            Controller.scrollUp()

        elif gesture == Gest.MID:  # Customize the condition based on your specific gesture
